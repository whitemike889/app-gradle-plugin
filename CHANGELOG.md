...
in either build.gradle using the `deploy.project` property or in appengine-web.xml using the `<application>` tag. 
`version` may be left unconfigured to be generated by gcloud, or it may be configured in your build.gradle or 
appengine-web.xml. To read values from appengine-web.xml, set the system property `deploy.read.appengine.web.xml=true` ([#255](https://github.com/GoogleCloudPlatform/app-gradle-plugin/issues/255)).
